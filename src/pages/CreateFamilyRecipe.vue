<template>
  <div class="container">
    ...
    <!-- Modal for creating a new family recipe -->
    <b-modal
      id="modal-2"
      ref="my-modal"
      title="Create New Family Recipe"
      hide-footer
      class="recipe-modal"
    >
      ...
      <b-form @submit.prevent="onSave" @reset.prevent="onReset">
        ...
        <!-- Input for recipe owner -->
        <b-form-group>
          <b-form-input
            id="input-recipe_owner"
            v-model="form.recipe_owner"
            type="text"
            placeholder="Enter the recipe owner name"
            required
          ></b-form-input>
        </b-form-group>

        <!-- Input for prepared time -->
        <b-form-group>
          <b-form-input
        ...
        <b-form-group>
          <b-form>
            <div class="header">
              <b-form-group> Ingredients: </b-form-group>
            </div>
            <b-row>
              <b-col>
                <b-form-group>
        ...
        <b-form-group>
          <div class="header">
            <b-form-group> Instruction: </b-form-group>
          </div>
        ...
        <b-row>
          <b-col>
            <b-button class="buttons" type="reset">Reset </b-button>
          </b-col>
          <b-col>
            <b-button type="submit" style="width: 100%" class="buttons"
              >Save
            </b-button>
          </b-col>
        </b-row>
...
export default {
  data() {
    return {
      ...
      // Data properties for ingredients and instructions
      form_ingredient: {
        ingredient: "",
        amount: "",
        unitLong: null,
  ...
  methods: {
    // Method to save the new family recipe 
    async Save() {
      try {
        // Fetch the user ID
